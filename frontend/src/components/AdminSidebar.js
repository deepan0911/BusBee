...
import { LayoutDashboard, Bus, BookOpen, Users, MapPin, Building2, ChevronLeft, ChevronRight } from "lucide-react"
...
const AdminSidebar = () => {
    ...
    const menuItems = [
        ...
        { path: "/admin/operators", icon: Building2, label: "Operators" },
    ]
